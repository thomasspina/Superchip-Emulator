...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "release-2.30.x"
  WORKING_DIRECTORY "/Users/thomas/code/chip-8_emulator/build/_deps/sdl2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/thomas/code/chip-8_emulator/build/_deps/sdl2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/thomas/code/chip-8_emulator/build/_deps/sdl2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
